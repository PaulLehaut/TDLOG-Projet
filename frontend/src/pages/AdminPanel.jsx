...
function AdminPanel({socket})
{
   ...
   async function créerQuestion(event)
   {
        ...
        try
        {
            ...
            editerAlerte({message: `Question ${nv_quest.énoncé} créé !`, type: 'success'});
   ...
   async function créerQuizIA(event)
   {
        ...
        editerAlerte({message: 'Génération lancée en arrière plan.', type: 'info'});
                ...
                <div className='tab-content'>
                    ...
                    {ongletActif === ONGLETS.CREER_QUIZ && (
                        <section className='card mb-4'>
                            ...
                            <div className='card-header'><h2>Créer un Nouveau Quiz</h2></div>
                            <form id = "form-creer-quiz" className='card-body' onSubmit={créerQuiz}>

                                <div className='mb-3'>
                                    <label htmlFor = "quiz-nom" className='form-label'>Nom du Quiz:</label>
                                    <input
                                    type = 'text'
                                    id = "quiz-nom"
                                    value = {nvQuizNom}
                                ...
                                <div className='mb-3'>
                                    <label htmlFor = "quiz-desc" className='form-label'>Description du Quiz:</label>
                                    <textarea
                                    id = 'quiz-desc'
                                    className='form-control'
                                    rows = '2'>
                    ...
                    {ongletActif === ONGLETS.AJOUTER_QUESTION && (
                        <section className='card'>
                            ...
                            <div className='card-header'><h2>Ajouter une Question</h2></div>

                            <form id = 'form-ajouter-question' className='card-body' onSubmit = {créerQuestion}>
                                ...
                                <div className='mb-3'>
                                    <label htmlFor = 'question-enonce' className='form-label'>Enoncé de la Question:</label>
                                    <input
                                    type = 'text'
                                    id = 'question-enonce'
                                    value = {nvQuestEnonce}
                                ...
                                <div className='row g-3 mb-3'>
                                    ...
                                    <div className='col-md-6'>
                                        <label htmlFor = 'question-sujet' className='form-label'>Sujet:</label>
                                        <input 
                                        type = 'text'
                                        id = 'question-sujet'
                                        value = {nvQuestSujet}
                                ...
                                <div className='mb-3'>
                                    <label htmlFor='selec-type-question' className='form-label'>Type de Question</label>
                                    <select id = 'select-type-question' className='form-select' value = {nvQuestType} onChange={(e) => editerNvQuestType(e.target.value)}>
                                ...
                                {(nvQuestType === 'qcm') && (
                                    <div id = 'propositions-container' className='mb-3'>
                                        <label className='form-label'>Propositions (pour QCM)</label>
                                        <input
                                        type = 'text'
                                        id = 'prop-1'
                                ...
                                <div className='mb-3'>
                                    <label htmlFor='question-reponse' className='form-label'>Réponse Correcte:</label>
                                    <input
                                    type = 'text'
                                    id = 'question-reponse'
                                    className='form-control'
                    ...
                    {ongletActif === ONGLETS.CREATION_IA && (
                        <section className='card mb-4'>
                            <div className = 'card-header'><h2> Générer un Quiz par IA</h2></div>

                            <form id = 'form-generer-ia' className='card-body' onSubmit = {créerQuizIA}>
                                ...
                                <div className='row g-3 mb-3'>
                                    ...
                                    <div className='col-md-6'>
                                        <label htmlFor='ia-quiz-nom' className='form-label'>Nom du Quiz:</label>
                                        <input 
                                        type = 'text'
                                        id = 'ia-quiz-nom'
                                        className = 'form-control'
                                    ...
                                    <div className='col-md-6'>
                                        <label htmlFor='ia-quiz-desc' className='form-label'>Description du Quiz:</label>
                                        <input 
                                        type = 'text'
                                        id = 'ia-quiz-desc'
                                        className = 'form-control'
                                ...
                                <div className='row g-3 mb-3'>
                                    ...
                                    <div className='col-md-6'>
                                        <label htmlFor = 'ia-nb-quest-simples' className='form-label'>Nombre de questions 'Simple':</label>
                                        <input 
                                        type = 'number'
                                        id = 'ia-nb-quest-simples'
                                        className='form-control'
                                        value = {nbQuestSimplesIa}
                                        onChange = {(e) => editerNbQuestionsSimplesIA(e.target.value)}
                                        />
                                    </div>

                                    <div className='col-md-6'>
                                        <label htmlFor = 'ia-nb-quest-qcm' className='form-label'>Nombre de questions QCM:</label>
                                        <input 
                                        type = 'number'
                                        id = 'ia-nb-quest-qcm'
                                        className='form-control'
                                ...
                                <button type = 'submit' id = 'btn-generer-ia' className='btn btn-warning'>Lancer la génération</button>
                            </form>
                        </section>
                    )}
